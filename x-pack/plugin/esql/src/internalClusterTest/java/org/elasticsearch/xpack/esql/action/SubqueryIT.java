...
public class SubqueryIT extends AbstractEsqlIntegTestCase {
    ...
    public void testNestedSubqueryProfileUsesHierarchicalNames() {
        ...
        var query = """
            ...
            | KEEP id
            """;
        try (var resp = run(syncEsqlQueryRequest(query).pragmas(batchPragmas(1)).profile(true))) {
    ...
    public void testNestedSubqueryOuterLimitWithQueuedLeaves() {
        ...
        var query = """
            ...
            | LIMIT 1
            """;
        try (var resp = run(syncEsqlQueryRequest(query).pragmas(batchPragmas(1)))) {
    ...
    private static QueryPragmas batchPragmas(int degree) {

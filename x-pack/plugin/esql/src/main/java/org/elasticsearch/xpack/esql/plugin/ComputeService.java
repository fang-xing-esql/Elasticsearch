...
public class ComputeService {
    ...
    public void execute(
        ...
        SubPlanExecutionPlan executionPlan = PlannerUtils.buildSubPlanExecutionPlan(physicalPlan);
        ...
        if (executionPlan instanceof SubPlanExecutionPlan.Leaf leaf) {
            executePlan(
                sessionId,
                rootTask,
                flags,
        ...
        new SubPlanExecutionRunner(
            ...
            execInfo,
            initialClusterStatuses
        ).execute((SubPlanExecutionPlan.Merge) executionPlan, planTimeProfile, listener);
    }

...
public class EsqlCapabilities {
    ...
    public enum Cap {
        ...
        /**
         * Support nested non-correlated subqueries in the FROM clause, i.e. a subquery whose own FROM
         * clause contains further subqueries or multiple index patterns.
         */

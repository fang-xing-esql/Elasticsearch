...
public class PlannerSettings {
     ...
     * on the breaker. 0.3 is good enough to have heap attack tests not OOM in non-serverless mode,
     * however, in serverless it is set to 1.5 to prevent OOMs under higher concurrency.
     */

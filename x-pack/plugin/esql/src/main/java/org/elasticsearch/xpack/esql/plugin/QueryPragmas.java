...
public final class QueryPragmas implements Writeable {
    ...
    /**
     * The query-wide maximum number of leaf fork or subquery producers executing concurrently. Coordinator merge segments do not count
     * toward the limit because they must remain able to consume nested producers when the degree is one.
     */

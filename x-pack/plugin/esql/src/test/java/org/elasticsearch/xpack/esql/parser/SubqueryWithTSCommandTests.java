...
/**
 * Parser tests for subqueries whose source command is {@code TS}.
 */
public class SubqueryWithTSCommandTests extends AbstractStatementParserTests {
    ...
    public void testMultipleTSSubqueriesOnly() {
        ...
        // STATS over a TS source produces a TimeSeriesAggregate which extends Aggregate.
